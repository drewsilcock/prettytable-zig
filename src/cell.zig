...
test "test print ascii" {
    var cell = try Cell.init(testing.allocator, "hello");
    defer cell.deinit();
...
test "test align left" {
    var cell = try Cell.initWithAlign(testing.allocator, "test", Alignment.left);
    defer cell.deinit();
...
test "test align center" {
    var cell = try Cell.initWithAlign(testing.allocator, "test", Alignment.center);
    defer cell.deinit();
...
test "test align right" {
    var cell = try Cell.initWithAlign(testing.allocator, "test", Alignment.right);
    defer cell.deinit();
